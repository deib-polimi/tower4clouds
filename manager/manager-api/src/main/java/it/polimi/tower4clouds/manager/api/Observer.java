...
public class Observer {
	...
	private transient Set<String> observerdQueriesUris; // TODO this should
														// probably be the list
														// of observed metrics
	...
	public Observer(String id, String callbackUrl, String protocol,
			String format) {
		setId(id);
	...
	public Observer(String id, String observerHost, int observerPort,
