...
public class ManagerConfigTest {
	...
	public void clearProperties() {
		System.clearProperty(Env.MODACLOUDS_MONITORING_DA_ENDPOINT_IP);
		System.clearProperty(Env.MODACLOUDS_MONITORING_DA_ENDPOINT_PORT);
	}
	...
	public void daIPFromSystemPropertyShouldOverrideDefault()
		...
		System.setProperty(Env.MODACLOUDS_MONITORING_DA_ENDPOINT_IP, expected);
		ManagerConfig.init();
	...
	public void daPortShouldBeANumber() throws ConfigurationException {
		System.setProperty(Env.MODACLOUDS_MONITORING_DA_ENDPOINT_PORT,
				"notaport");
		ManagerConfig.init();
	}
